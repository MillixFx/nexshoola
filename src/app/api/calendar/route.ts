...
export async function POST(req: NextRequest) {
  try {
    ...
    const event = await prisma.calendarEvent.create({ data: { schoolId, title, description, startDate: new Date(startDate), endDate: endDate ? new Date(endDate) : null, type, color } })
