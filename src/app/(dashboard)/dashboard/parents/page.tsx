  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Manage parent profiles and student linkages.</p>
      </div>
      <div className="bg-white rounded-2xl border border-gray-100 p-12 shadow-sm flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-bold text-gray-800 mb-2">Parents Module</h2>
        <p className="text-sm text-gray-500 max-w-sm">Manage parent profiles and student linkages. This module is actively being built.</p>
